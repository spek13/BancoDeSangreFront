 ...
 <div class="row">
  <div class="col-sm-2 admin-sidebar">
    <div class="nav flex-column nav-pills text-center text-uppercase admin-nav" id="sidebar-admin" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link admin-nav-item admin-sidebar-item"  data-toggle="pill" href="https://bloodbanck-452b3.web.app//panel/master" v-if="user.rol=='2'" role="tab" aria-controls="admin-userss" aria-selected="false">donadores</a>
        <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="https://bloodbanck-452b3.web.app//panel/logs" v-if="user.rol=='2'" role="tab" aria-controls="admin-userss" aria-selected="false">logs</a>
       
        <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="https://bloodbanck-452b3.web.app//panel/cuestionario" v-if="user.rol=='1' " role="tab" aria-controls="admin-analytics" aria-selected="false">generar una cita</a>
        <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="https://bloodbanck-452b3.web.app//panel/historialcitas" v-if="user.rol=='1'" role="tab" aria-controls="admin-messages" aria-selected="false">historial de citas</a>
        <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="https://bloodbanck-452b3.web.app//panel/ultimacita" v-if="user.rol=='1'" role="tab" aria-controls="admin-sessions" aria-selected="false">ultima cita</a>
        
        <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="https://bloodbanck-452b3.web.app//panel/publicacion"  v-if="user.rol=='3'" role="tab" aria-controls="admin-sessions" aria-selected="false">crear publicacion</a>
        <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="https://bloodbanck-452b3.web.app//panel/listapacientes" v-if="user.rol=='4'" role="tab" aria-controls="admin-sessions" aria-selected="false">ver citas</a>
