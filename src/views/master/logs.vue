  ...
  <div class="row">
    <div class="col-sm-2 admin-sidebar">
        <div class="nav flex-column nav-pills text-center text-uppercase admin-nav" id="sidebar-admin" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link admin-nav-item admin-sidebar-item"  data-toggle="pill" href="master" v-if="rol=='2'" role="tab" aria-controls="admin-userss" aria-selected="false">donadores</a>
            <a class="nav-link admin-nav-item admin-sidebar-item" data-toggle="pill"  href="logs" v-if="rol=='2'" role="tab" aria-controls="admin-userss" aria-selected="false">logs</a>
